...
def main():
    ...
    print ("Loading handlers for telegram bot")

    # Default dispatcher (this is related to the first bot in settings.TELEGRAM_BOT_TOKENS)
    #dp = DjangoTelegramBot.dispatcher
    # To get Dispatcher related to a specific bot
    dp = DjangoTelegramBot.getDispatcher('879043364:AAGDXv6TvnBGFt5qatSnw92FqZKW6STWsT0')     #get by bot token
    dp = DjangoTelegramBot.getDispatcher('my_scv_bot')  #get by bot username
